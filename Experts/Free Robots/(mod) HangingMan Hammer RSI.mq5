...
#property description "MOD - Low Balance Version ($14, Leverage 1:100)"
#property description "NZDUSD H1 | Lot 0.01 | SL 80 | TP 160 | Duration 6 bars | RRR 1:2"
...
//--- trade parameters
input uint InpDuration=6;           // position holding time in bars (MOD: 6 bars = 6H max hold on H1)
input uint InpSL      =80;          // Stop Loss in points (MOD: 80 pts = $0.80 risk at 0.01 lot)
input uint InpTP      =160;         // Take Profit in points (MOD: 160 pts = $1.60 reward, RRR 1:2)
input uint InpSlippage=10;          // slippage in points
//--- money management parameters
input double InpLot=0.01;           // lot (MOD: reduced to 0.01 for low balance)
//--- Expert ID
